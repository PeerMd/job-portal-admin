...
const CreateJobPage = () => {
  ...
  const onSubmit = async (data: JobFormData) => {
    const isDuplicate = jobs.some(
      (job: Job) =>
        job.title.toLowerCase().trim() === data.title.toLowerCase().trim() &&
        job.company.toLowerCase().trim() === data.company.toLowerCase().trim() &&
        job.location.toLowerCase().trim() === data.location.toLowerCase().trim()
    )
    ...
    if (createJobThunk.fulfilled.match(result)) {
      ...
      toast.error((result.payload as string) || "Failed to create job.")
    }
  }
    ...
    <PageTransition>
      <div className="space-y-6 max-w-2xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Create Job</h2>
            <p className="text-gray-500 mt-1">Add a new job listing</p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input placeholder="e.g. Chennai, India" {...register("location")} />
                  {errors.location && (
                ...
                <div className="space-y-1">
                  ...
                  <Select defaultValue="" onValueChange={(val) => setValue("category", val)}>
                ...
                <div className="space-y-1">
                  ...
                  <Select defaultValue="" onValueChange={(val) => setValue("experienceLevel", val)}>
                    <SelectTrigger className="w-full">
                ...
                <div className="space-y-1">
                  ...
                  <Select defaultValue="" onValueChange={(val) => setValue("jobType", val)}>
                    <SelectTrigger className="w-full">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  className="w-full border border-gray-200 rounded-md px-3 py-2 text-sm min-h-[120px] focus:outline-none focus:ring-2 focus:ring-blue-500"
